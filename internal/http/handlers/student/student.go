...
import (
	...
	"github.com/codingsher/golang-student-api/internal/storage"
	"github.com/codingsher/golang-student-api/internal/types"
	"github.com/codingsher/golang-student-api/internal/utils/response"
...
func UpdateByID(storage storage.Storage) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		id := r.PathValue("id")
		slog.Info("updating student record...")
